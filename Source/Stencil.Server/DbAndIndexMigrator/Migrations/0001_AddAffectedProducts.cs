...
{
    [Migration(Version, "Add the AffectedProducts join table")]
    public class _0001_AddAffectedProducts : StencilDbMigrationBase
    {
        public const int Version = 1;

        public _0001_AddAffectedProducts(IFoundation foundation) 
			: base(foundation)
        {
        }
...
");
        ...
        {
			client.Map<sdk.AffectedProduct>(p => 
				p.Index(this.IndexName)
				 .Type(DocumentNames.AffectedProduct)
			     .AutoMap()
            ...
            client.Map<sdk.Ticket>(p => 
                p.Index(this.IndexName)
                 .Type(DocumentNames.Ticket)
                    .Properties(props => props
                        .String(m => m
